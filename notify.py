...
push_config = {
    ...
    'QYWX_AM': 'ww8a8648d68b7891f6,NGapOO7wq_4tjy1GB0ibv94yFkvpwsEun3H-dupZvto,jiaotangyaoyao|wanbaba,1000001',# corpid,corpsecret,touser(注:多个成员ID使用|隔开),agentid,消息类型(选填,不填默认文本消息类型) 注意用,号隔开(英文输入法的逗号)，例如：wwcfrs,B-76WERQ,qinglong,1000001,2COat
